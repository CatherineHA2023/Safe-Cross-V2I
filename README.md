...
## AI 사용
본 프로젝트는 연구 및 코드 구현의 효율성을 극대화하기 위해 생성형 AI 도구(Google Gemini, Anthropic Claude)를 활용하였습니다.

- **코드 구현 및 알고리즘 최적화:** ROS 2 Python 제어 노드 구조 설계 및 Gazebo C++ 시스템 플러그인 좌표계 보정 로직 구현 
- **디버깅 및 문제 해결:** 시뮬레이터 엔진 주기 개입 알고리즘의 예외 처리 및 이기종 통신 브릿지 데이터 매핑 트러블슈팅
- **문서화:** 시스템 파이썬/C++ 노드 분석 자료 및 발표 스크립트 초안 작성
